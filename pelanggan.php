...
$query = " SELECT * FROM pelanggan
 ORDER BY ID_PELANGGAN ASC LIMIT 0, 99";
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="text-center">
						<h3>Data Pelanggan SIB2 grup</h3><hr>
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered">
							...
							<?php foreach ($sql as $member) : ?>
								<tr>
									<td><?php echo $member['ID_PELANGGAN']; ?></td>
									<td><?php echo $member['ID_PEMESANAN']; ?></td>									
									<td><?php echo $member['ID_PEGAWAI']; ?></td>
									<td><?php echo $member['NAMA_PELANGGAN']; ?></td>
									<td><?php echo $member['TELP_PELANGGAN']; ?></td>
									<td><?php echo $member['ALAMAT_PELANGGAN']; ?></td>
									<td><?php echo $member['KODE_POS_PELANGGAN']; ?></td>
									<td><?php $member['STATUS_PELANGGAN'];
									if($member['STATUS_PELANGGAN']==1){
										echo "Aktif";
									}
									else {
										echo "Non-Aktif";
									...
									?></td>
									<td>
										<a href="pages/edit_domba.php?id=<?php echo $member['ID_PELANGGAN']; ?>
										" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-pencil"> Edit</span></a>
										<a href="process/hapus_domba_proses.php?id=<?php echo $member['ID_PELANGGAN']; ?>
